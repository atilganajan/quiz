<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            <div class="text-2xl mb-2">Puan : <strong>{{$quiz->my_result->point}}</strong></div>
            <div class="alert bg-light">
                <i class="fa fa-circle-dot"></i> İşaretlediğin Şık <br>
            ...
            @foreach ($quiz->questions as $question)
                ...
                <br>
                <small>Bu soruya <strong>%{{ $question->true_perencent }} </strong> oranında doğru cevap verildi</small>
